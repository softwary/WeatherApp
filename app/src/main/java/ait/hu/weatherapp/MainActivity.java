...
public class MainActivity extends AppCompatActivity
    ...
    private DrawerLayout activity_nav_main;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        activity_nav_main = findViewById(R.id.drawer_layout);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.btnAddCity) {
            ...
            Snackbar.make(activity_nav_main, "Replace with your own action", Snackbar.LENGTH_LONG)
